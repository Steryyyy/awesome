...
local function manage(c)
	...
	c.keys = gears.table.join(
		awful.key({'Mod4'}, "Return", function()Request = true awful.spawn.with_shell(term_com) end),
		awful.key({'Mod4'}, "f", function()fullhight = not fullhight terminals[index].height = (fullhight and mouse.screen.geometry.height or mouse.screen.geometry.height / 2)end),
		awful.key({'Mod4'}, "KP_Left", function() c.width = c.screen.geometry.width / 2 c.height = c.screen.geometry.height c.x = c.screen.geometry.x c.y = c.screen.geometry.y end),
		awful.key({'Mod4'}, "KP_Right", function()c.width = c.screen.geometry.width / 2 c.height = c.screen.geometry.height c.x = c.screen.geometry.width - c.width + c.screen.geometry.x c.y = c.screen.geometry.y end),
		awful.key({'Mod4'}, "KP_Up", function()c.width = c.screen.geometry.width c.height = c.screen.geometry.height / 2 c.x = c.screen.geometry.x c.y = c.screen.geometry.y end),
		awful.key({'Mod4'}, "KP_Down", function() c.width = c.screen.geometry.width c.height = c.screen.geometry.height / 2 c.x = c.screen.geometry.x c.y = c.screen.geometry.height - c.height + c.screen.geometry.y end),
